...
<!--                                --><?php //endif ?>
                        ...
                        <tr style="text-align:left;font-size:13px;">
                            ...
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo $invHed->CusCode; ?></td>
                            <td></td>
                        ...
                        <tr style="text-align:left;font-size:13px;">
                            ...
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo date('Y-m-d', strtotime($invHed->CusName)); ?></td>
                            <td></td>
                            <td style="text-align:left;">Invoice Date</td>
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo date('Y-m-d', strtotime($invHed->SalesInvDate)); ?></td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
                            <td style="text-align:left;">Customer Address</td>
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo ($invHed->Address01 > 0) ? 'CREDIT' : 'CASH'; ?></td>
                            <td></td>
                            <td style="text-align:left;">Invoice Time</td>
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo ($invHed->JobCreditAmount > 0) ? 'CREDIT' : 'CASH'; ?></td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
                            <td style="text-align:left;">Customer Contact No</td>
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo ($invHed->MobileNo > 0) ? 'CREDIT' : 'CASH'; ?></td>
                            <td></td>
                            <td style="text-align:left;">Invoice Route</td>
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo ($invHed->RootNo > 0) ? 'CREDIT' : 'CASH'; ?></td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
